      ...
      <div className=" sticky top-1 z-50 bg-slate-400 rounded-xl">
        <div className="flex justify-around">
          <div className="flex items-end">
            ...
            ></Image>
            <h1 className={`${bebas.className} text-2xl md:text-3xl ml-1`}>
              BILALI MASJID
            </h1>
          </div>
          ...
          <div
            className={`${poppins.className} font-[500] flex items-center gap-2`}
          >
            <Dialog>
              ...
              <DialogContent className=" bg-white shadow-lg rounded-xl p-4">
                <DialogHeader>
                  ...
                  <DialogTitle className="text-xl text-green-600 font-semibold">
                    {namaz === null ? "NoDate" : namaz.islamicDate}
                  </DialogTitle>
                  ...
                  <DialogTitle className="text-xl  font-bold">
                    ...
                    <span className="text-2xl ml-2 text-red-500">
                      {namaz === null ? "NoDate" : namaz.sehriTime}
                    </span>
                  </DialogTitle>
                  ...
                  <DialogTitle className="text-xl  font-bold">
                    Iftari Time :{" "}
                    <span className="text-2xl ml-2 text-green-700">
                      {namaz === null ? "NoDate" : namaz.iftarTime}
                    </span>
                  </DialogTitle>
                  ...
                  <DialogTitle className="text-xl  font-bold">
                    Maghrib Jamat :{" "}
                    <span className="text-2xl ml-2 text-blue-700">
                      {namaz === null ? "NoDate" : namaz.prayers.Maghrib.jamat}
                    </span>
                  </DialogTitle>
                  ...
                  <p className="text-center text-black font-arabic text-lg">
                    اَللّٰهُمَّ اِنِّی لَکَ صُمْتُ وَبِکَ اٰمَنْتُ وَعَلَيْکَ
                    تَوَکَّلْتُ وَعَلٰی رِزْقِکَ اَفْطَرْتُ
                  </p>
                </DialogHeader>
              </DialogContent>
            </Dialog>
